        ...
        return (
            <div>
                ...
                <NeoRow style={{marginTop:'32px', justifyContent:'flex-start'}}>
                    <NeoButton style={{width:'111px', marginRight:'20px'}} onClick={() => this.onClick()}>
                        {t('delete')}
                    </NeoButton>
                    <NeoButton type={"secondary"} style={{ width:'120px', color: 'fff'}} onClick={() => this.props.handleDeleteMenuForCancel()}>
                        {t('cancel')}
                    </NeoButton>
                </NeoRow>
            </div>
