...
public class TestFactoryImpl extends EFactoryImpl implements TestFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case TestPackage.GROUP: return createGroup();
			case TestPackage.USER: return createUser();
			case TestPackage.COLUMN: return createColumn();
			case TestPackage.PKEY: return createPKey();
			case TestPackage.IE_KEY: return createIEKey();
			case TestPackage.FKEY: return createFKey();
			case TestPackage.DB_TABLE: return createDBTable();
			case TestPackage.DB_VIEW: return createDBView();
			case TestPackage.META_VIEW: return createMetaView();
			case TestPackage.OPOINT: return createOPoint();
			case TestPackage.OMULTI_POINT: return createOMultiPoint();
			case TestPackage.OLINE_STRING: return createOLineString();
			case TestPackage.OMULTI_LINE_STRING: return createOMultiLineString();
			case TestPackage.OPOLYGON: return createOPolygon();
			case TestPackage.OMULTI_POLYGON: return createOMultiPolygon();
			case TestPackage.ORECTANGLE: return createORectangle();
			case TestPackage.OGEOMETRY_COLLECTION: return createOGeometryCollection();
			case TestPackage.PLACEMARK: return createPlacemark();
			case TestPackage.COUNTRY: return createCountry();
			default:
